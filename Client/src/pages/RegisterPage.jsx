...
export default function RegisterPage() {
  ...
  return (
    <div className='flex flex-row w-full h-screen items-center justify-center md:mt-10 md:mb-10'>
      <div className='appBoxShadow h-full flex flex-col items-center justify-center w-full bg-white md:rounded-2xl md:w-1/3  pb-5'>
        ...
        <h2 className='font-bold text-center p-1'>Enter details for register</h2>
            <form onSubmit={handelForm} className=' flex flex-col items-center justify-evenly w-full h-3/5' action="">
              ...
              <button type="submit" class="mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w=-1/2">Register</button>
              </form>

            <Link to='/login' className='mt-3 text-center w-5/6 hover:text-white'>Already have a account</Link>
        </div>
