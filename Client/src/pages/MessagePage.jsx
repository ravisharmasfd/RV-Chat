...
function MessagePage() {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9.75L14.25 12m0 0l2.25 2.25M14.25 12l2.25-2.25M14.25 12L12 14.25m-2.58 4.92l-6.375-6.375a1.125 1.125 0 010-1.59L9.42 4.83c.211-.211.498-.33.796-.33H19.5a2.25 2.25 0 012.25 2.25v10.5a2.25 2.25 0 01-2.25 2.25h-9.284c-.298 0-.585-.119-.796-.33z" />
            ...
            <div onClick={()=>{navigate(`/profile/${person?.userName}`)}} className='hover:border-solid hover:border-4 hover:border-third cursor-pointer hover:scale-125 mr-5 aspect-square w-[10%] max-w-[40px] min-w-[20px] rounded-full overflow-hidden border-white border-2 border-solid'><img src={person?.dp} alt="person" /></div>
